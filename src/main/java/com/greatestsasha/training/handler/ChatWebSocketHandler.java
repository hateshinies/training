package com.greatestsasha.training.handler;
...
public class ChatWebSocketHandler implements WebSocketHandler {
    ...
    private final RedisMessagePublisher redisChatMessagePublisher;
    private final RedisAtomicLong activeUserCounter;
    private final ObjectStringConverter objectStringConverter;

    public ChatWebSocketHandler(Sinks.Many<ChatMessage> chatMessageSink, RedisMessagePublisher redisChatMessagePublisher,
